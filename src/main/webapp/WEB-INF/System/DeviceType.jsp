...
<body>
	...
	<div class="content-area">
		<!--面包屑-->
		<div class="content-title">设备类型</div>
		<!--//面包屑-->
		<!--内容盒-->
								...
								<div class="extend-button">
									...
									<div class="button">
										<a href="javascript:void(0);"
											onclick="frm.add({ title: '添加设备类型', formId: 'DeviceParameterFormTemplate', callback: deviceType.addDeviceTypeParameter, width: 800, height: 400 });"
											class="btn">添加设备类型</a>
									</div>
