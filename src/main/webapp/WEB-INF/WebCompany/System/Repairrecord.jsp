								...
								<div class="extend-button">
									...
									<div class="button">
										<a href="javascript:void(0);"
											onclick="frm.add({ title: '添加', formId: 'RepairrecordFormTemplate', callback: repairrecord.addrepairrecord , width: 800, height: 400 });"
											class="btn">添加报告</a>
									</div>
							...
							<table border="0" cellpadding="0" cellspacing="0">
								...
								<thead>
									<tr>
										...
										<td>
											<p class="name center">是否整改</p>
										</td>
										<td>
											<p class="name center">报告创建时间</p>
										</td>
										<td>
...
<script language="javascript" type="text/javascript">
 ...
 function load(){
	  var config={
				url:companypath+"/device/showRepairrecord.do",
	  			pageSize:10,
	  			pageIndex:1,
	  			barSize:3,
